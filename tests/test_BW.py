...
class TestBlancNoir(unittest.TestCase):
    def setUp(self):
        self.app = app.test_client()

    def test_blanc_noir(self):
        ...
        # Send a POST request to the /change_color route with the sample image
        ...
        reference_image_path = os.path.abspath(os.path.join(os.path.dirname(__file__), './resources/test_image-noirEtBlanc.png'))
