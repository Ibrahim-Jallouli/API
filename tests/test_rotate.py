...
class TestRotate(unittest.TestCase):
    ...
    def test_rotate(self):
        ...
        # Send a POST request to the /rotate route with the sample image
        response = self.app.post('/rotate', json={'image_data': f'data:image/png;base64,{sample_image_base64}'})
        ...
        reference_image_path = os.path.abspath(os.path.join(os.path.dirname(__file__), './resources/test_image-rotate90.png'))
